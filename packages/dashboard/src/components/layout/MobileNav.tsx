...
import { UserProfileFooter } from './Sidebar';
...
const navItems = [
  ...
  { href: '/funnels', label: 'Funnels', icon: 'M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12' },
  { href: '/flags', label: 'Feature Flags', icon: 'M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2z' },
  ...
  { href: '/test-links', label: 'Test Links', icon: 'M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244' },
...
export function MobileNav({
  ...
  return (
    <>
      ...
      <header className="fixed left-0 right-0 top-0 z-40 flex h-14 items-center justify-between border-b border-gray-800 bg-gray-950 px-4 md:hidden">
        <h1 className="text-base font-bold text-gray-100">Analytics</h1>
        <button
      ...
      {/* Slide-out drawer */}
      <div
        className={`fixed left-0 top-0 z-50 flex h-full w-64 flex-col border-r border-gray-800 bg-gray-950 transition-transform duration-300 ease-in-out md:hidden ${
      ...
      >
        ...
        {/* Company + project switchers — kept consistent with the desktop Sidebar */}
