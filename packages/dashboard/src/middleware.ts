...
export const config = {
  matcher: [
    ...
    '/((?!login|forgot-password|reset-password|accept-invite|api/collect|api/health|api/auth|api/invitations/accept|api/account|api/projects|api/cli-auth/device|api/cli-auth/poll|_next/static|_next/image|favicon.ico|robots.txt).*)',
  ],
};
